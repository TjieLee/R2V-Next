...
from ltx_trainer.training_strategies.semantic_vlm_flow import SemanticVLMFlowConfig, SemanticVLMFlowStrategy
...
def get_training_strategy(config: TrainingStrategyConfig) -> TrainingStrategy:
    ...
    match config:
        ...
        case SemanticVLMFlowConfig():
            strategy = SemanticVLMFlowStrategy(config)
        case _:
